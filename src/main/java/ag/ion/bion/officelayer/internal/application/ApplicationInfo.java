...
public class ApplicationInfo implements IApplicationInfo {
    ...
    //----------------------------------------------------------------------------  
    /**
     * Returns the date when the license of the office application was accepted, or
     * <code>null</code> if not available.
     *
     * @return the date when the license of the office application was accepted, or
     *         <code>null</code> if not available
     *
     * @throws Exception if retreiving the value fails
     *
    ...
    //----------------------------------------------------------------------------  
    /**
     * Returns if the first start wizard is already completed as Boolean, or <code>null</code> if
     * not available.
     *
     * @return if the first start wizard is already completed as Boolean, or <code>null</code> if
     *         not available
     *
     * @throws Exception if retreiving the value fails
     *
    ...
    public String getOfficeHome() {
        IOfficeConnection officeConnection = serviceProvider.getOfficeConnection();
        if (officeConnection instanceof LocalOfficeConnection) {
            return ((LocalOfficeConnection) officeConnection).getOfficePath();
        }
        else {
            return officeConnection.getHost();
        }
    }
